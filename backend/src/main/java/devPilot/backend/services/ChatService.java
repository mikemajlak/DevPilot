 ...
 *
 * <p>
 * {@link #streamReply} orchestrates the full flow: validate → save user message
 * → retrieve code context → build prompts → stream AI reply. Each step is
 * implemented in a dedicated class under {@code service.ai}.
 */
@Service
